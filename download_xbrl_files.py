...
def fetch_ticker_list(list_name='sample_list'): 
    ...
    if list_name == 'all_companies':
        ...
        ticker_list = ['MSFT','GOOG','AMZN','NVDA','ORCL','INTC','CRM','TSLA','FB','AAPL','NFLX','ZM','TEAM','BYND','OKTA','ZM','ZEN','ADBE','UBER','LYFT','PINS','CRWD','SPOT','SVMK']
...
for cik in cik_list:
    ...
    try:
        shutil.rmtree('{path}sec_filings/', ignore_errors=False, onerror=None)
    except:
